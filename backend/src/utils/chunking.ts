...
export function chunkCues(
  ...
  for (const cue of cues) {
    ...
    // If the cue itself exceeds bounds, put it in its own chunk or split.
    // Here, if adding this cue would exceed limits, push the current chunk and start a new one.
    const wouldExceed =
